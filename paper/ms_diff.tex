...
%DIF DEL ms_old.tex   Tue Jun 14 08:14:54 2016
%DIF ADD ms.tex       Tue Jun 14 14:14:18 2016
...
experiments and provide public access to the data.
...
\citep{Hayashino2004,Gawiser2007,Ouchi2010,Bielby16}
}%DIFAUXCMD
. 
...
\caption{One and two dimensional projections of the posterior
  ...
  \DIFaddbeginFL \DIFaddFL{Vertical lines in the one dimensional projections correspond to the
  14-50,84 percentiles of the distributions.
...
uncertainties on the parameters }\mmin\, \focc \DIFadd{and $M_{50}$.
...
for }\mmin\, \focc\ \DIFadd{and $M_{50}$.
}
...
\DIFaddbegin \DIFadd{The authors acknowledge the referee, Nelson Padilla, for useful
remarks and questions that helped us to improve the quality and
clarity of our paper. The authors also acknowledge Valentino Gonzalez,
...
\DIFdelend \DIFaddbegin \bibitem[{{Klypin} {et~al.}(2016){Klypin}, {Yepes}, {Gottl{\"o}ber}, {Prada},
  \& {He{\ss}}}]{BolshoiP}
\DIFaddend {Klypin}, A., {Yepes}, G., {\DIFdelbegin \DIFdel{Gottlober}\DIFdelend \DIFaddbegin \DIFadd{Gottl}{\"o}\DIFadd{ber}\DIFaddend }, S., {Prada}, F., \& {\DIFdelbegin \DIFdel{Hess}\DIFdelend \DIFaddbegin \DIFadd{He}{\DIFadd{\ss}}\DIFaddend }, S.
...
{\DIFadd{Norberg}}\DIFadd{, P., }{\DIFadd{Baugh}}\DIFadd{, C.~M., }{\DIFadd{Gazta}{\~n}\DIFadd{aga}}\DIFadd{, E., }\& {\DIFadd{Croton}}\DIFadd{, D.~J. 2009,
  }\mnras\DIFadd{, 396, 19
}
