...
To this end, we constructed mock catalogs from an N-body simulation to match the 
...
uncertainty resulting from the cosmic variance on these fields. {\bf  \citet{Guaita2010} attempted to analytically 
estimate the uncertainty from cosmic variance 
following \citet{Somerville2004} and \citet{Peebles1980}. Their prescription assumes 
...
likelihood of the parameters given the observational constraints. {\bf This approach 
...
at $z\sim 3$  with Ly-$\alpha$ {\bf rest-frame} equivalent widths $\gtrsim$65\AA\ and a  Ly-$\alpha$ flux limit
...
{\bf The result in Eq.(\ref{eq:focc}) can be qualitatively understood as
follows.   
...
masses. 
A valid questions is the following. Down to which values of
