...
Given that the typical scatter  in $N_{\mathrm halos}$ is about 0.3 dex (i.e. about  a factor of 2), our parameter space is restricted to models where the median number of dark matter halos is larger than  $N_{\rm LAE}/3$. 
...
Fig. \ref{fig:cosmicv0}).%in the number of dark matter halos along the
                         %mock fields  
