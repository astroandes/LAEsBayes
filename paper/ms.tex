...
performed in a cubic  comoving volume of 250 $h^{-1}$\hMpc  on a side. 
...
previous estimates reported by
 \citet{Bielby16} ($\log M_{50} = 10^{11.0\pm0.6} \hMsun$),
 \citet{Gawiser07} ($\log M_{50}= 10^{10.9\pm0.9} \hMsun$) and
 \citet{Ouchi2010} ($\log M_{50} = 10^{10.8^{+1.8}_{-0.8}} \hMsun$) 
