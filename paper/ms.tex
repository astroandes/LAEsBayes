...
${\mathcal M}$ by  means of the Markov Chain Monte Carlo technique using
...
\item ALSO MENTION THIS HERE BECAUSE IS A STRONG CONSTRAIN:
 the 1-$\sigma$ width of the mass distribution is highly constrained to be between $0.2$ and $0.6$ dex. 
