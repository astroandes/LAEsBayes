...
$1\sigma$ mass gap $\Delta M_{1\sigma}\approx 0.4$ dex.
...
This result imposes constraints on different models for LAEs formation
in a cosmological context as to why observable LAEs are constrained
into a narrow halo mass range.

Overall, our approach highlights the importance of forward modelling
to take explicitly into account the effects of cosmic variance.
We expect this 
